                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="text-holder">
                                                ...
                                                <p>Mengutamakan kepentingan Client agar dapat memiliki Teknologi 
                                                    Sistem Informasi terdepan untuk meningkatkan kualitas layanan.</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon-holder">
                                            ...
                                            <div class="text-holder">
                                                ...
                                                <p>Harga kompetitif dengan kualitas yang unggul di bidangnya.</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon-holder">
                                            ...
                                            <div class="text-holder">
                                                ...
                                                <p>Memberikan layanan pemeliharaan dan pendampingan terbaik untuk klien, karena anda adalah prioritas kami.</p>
                                            </div>
                                        </li>
                            ...
                            <div class="col-md-5">
                                <div class="mission-video-gallery">
                                    <div class="video-holder">
                                        <img src="landing/images/company-overview/mission-video-gallery.jpg" alt="Awesome Video Gallery">
                                        <div class="overlay-gallery">
                                            <div class="icon-holder">
                                                <div class="icon">
                                                    <a class="html5lightbox" title="Assurance Video Gallery" href="https://www.youtube.com/watch?v=XOv7RmXi7VE"><img src="landing/images/icon/play-btn-1.png" alt="Play Button"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
