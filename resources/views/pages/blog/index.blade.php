    ...
    <body>
        <div class="boxed_wrapper">
            ...
            <section class="breadcrumb-area"
                style="background-image: url(images/blog/banner-blog.jpg); width: 1920px; height: 340px">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="single-blog-post">
                                <div class="img-holder">
                                    <img src="landing/images/blog/v2-1.jpg" alt="Awesome Image">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="single-blog-post">
                                <div class="img-holder">
                                    <img src="landing/images/blog/v2-2.jpg" alt="Awesome Image">
                                    <div class="published-date">
                                        <h3>17 May</h3>
                                    </div>
                                    <div class="overlay-style-one">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="single-blog-post">
                                <div class="img-holder">
                                    <img src="landing/images/blog/v2-3.jpg" alt="Awesome Image">
                                    <div class="published-date">
                                        <h3>24 Apr</h3>
                                    </div>
                                    <div class="overlay-style-one">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="single-blog-post">
                                <div class="img-holder">
                                    <img src="landing/images/blog/v2-4.jpg" alt="Awesome Image">
                                    <div class="published-date">
                                        <h3>27 Apr</h3>
                                    </div>
                                    <div class="overlay-style-one">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="single-blog-post">
                                <div class="img-holder">
                                    <img src="landing/images/blog/v2-5.jpg" alt="Awesome Image">
                                    <div class="published-date">
                                        <h3>23 May</h3>
                                    </div>
                                    <div class="overlay-style-one">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="single-blog-post">
                                <div class="img-holder">
                                    <img src="landing/images/blog/v2-6.jpg" alt="Awesome Image">
                                    <div class="published-date">
                                        <h3>05 May</h3>
                                    </div>
                                    <div class="overlay-style-one">
                            ...
                            <div class="col-md-12">
                                <div class="footer-top-content">
                                    <div class="title pull-left">
                                        <h4>Lebih dari 20 tahun pengalaman kami akan memastikan Anda selalu mendapatkan yang terbaik</h4>
                                    </div>
